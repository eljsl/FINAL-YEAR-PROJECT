...
RandomTop=G(1:121,181:200); % Lowest 50 scoring, top half of each gene
RandomBottom=G(122:end,151:200); % Lowest 50 scoring, bottom half of gene
New100=[RandomBottom;RandomTop]; % Rearranged lowest 50 scoring
