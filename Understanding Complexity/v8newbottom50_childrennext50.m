...
NewBottom50Genes=randi([1 6],243,50);
G(:,1:50)=NewBottom50Genes;
% New100=randi([1 6],243,100);
Best50Top=G(1:121,151:200); % Lowest 50 scoring, top half of each gene
SecondBest50Bottom=G(122:end,101:150); % Lowest 50 scoring, bottom half of gene
New50=[Best50Top;SecondBest50Bottom]; % Rearranged lowest 50 scoring
G(:,51:100)=New50; % Putting rearranged 50 back into G
