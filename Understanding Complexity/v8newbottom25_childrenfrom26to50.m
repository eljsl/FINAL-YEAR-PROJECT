...
G(:,1:25)=NewBottom25Genes;
% New100=randi([1 6],243,100);
Best25Top=G(1:121,176:200); % Lowest 50 scoring, top half of each gene
SecondBest25Bottom=G(122:end,126:150); % Lowest 50 scoring, bottom half of gene
New25=[Best25Top;SecondBest25Bottom]; % Rearranged lowest 50 scoring
G(:,26:50)=New25; % Putting rearranged 50 back into G
